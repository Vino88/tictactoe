...
public class GameService {
    ...
    @Transactional
    public Game create(AppUser appUser, boolean playerGoFirst, int boardSize) {
        ...
        game.setRows(BoardUtil.createEmpty(boardSize));
    ...
    public void takeTurn(Game game, String tileId) {
        ...
        GameState state = evaluateGameState(game.getRows(), game.getBoardSize());
        game.setState(state);
    ...
    private GameState evaluateGameState(List<List<String>> rows, int boardSize) {
        for (List<String> line : BoardUtil.getAllLines(rows, boardSize)) {
